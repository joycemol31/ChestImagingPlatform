...
class VesselParticlesPipeline:
    ...
    def __init__(self,ct_file_name, pl_file_name, regions, tmp_dir, output_prefix, init_method='Frangi',
                 ...
                 voxel_size=0, min_scale=0.7, max_scale=4, vesselness_th=0.38, crop=0, rate=1, multires=True,
                 justparticles=True, clean_cache=True, permissive=False, heq_dir=None):
